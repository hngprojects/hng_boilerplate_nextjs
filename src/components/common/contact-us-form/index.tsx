    ...
    <>
      <div className="mx-auto w-full max-w-[80%] p-8">
        <form
          ...
          className="bg-subtle mb-4 w-full max-w-[80%] rounded px-8 pb-8 pt-6"
          role="form"
        >
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onChange={handleChange}
              className="bg-subtle w-full appearance-none rounded border-2 px-3 py-2 pb-[112px] leading-tight"
            />
            {errors.message && (
              <p className="text-xs italic text-destructive">
                {errors.message}
