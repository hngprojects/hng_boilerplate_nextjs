...
type ColorVal = { bgColor: string; textColor: string; arrowColor: string };
// { primary: ColorVal; secondary: ColorVal; neutral: ColorVal }
const colorStyles: Record<ColorVariant, ColorVal> = {
  primary: {
    bgColor: "bg-[#F97316]",
...
>(
  (
    ...
    const colorVariantKey: ColorVariant = colorVariant ?? "primary";
    ...
    return (
      ...
      >
        ...
        {body && (
          <div
            className="mb-1 overflow-hidden truncate text-[14px] font-medium leading-[16.94px] lg:whitespace-normal"
            style={{
              display: "-webkit-box",
              overflow: "hidden",
        ...
        {subText && (
          <div
            className="hidden overflow-hidden whitespace-normal text-[12px] font-[400] leading-[14.52px] xl:block"
            style={{
              display: "-webkit-box",
              overflow: "hidden",
              WebkitBoxOrient: "vertical",
