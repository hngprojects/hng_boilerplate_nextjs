...
> = (properties) => {
  ...
  return (
    <div className="renewal-with-icon box-border flex w-full max-w-full flex-col items-center justify-start gap-[40px] bg-background px-14 pb-[53px] pt-14 text-left font-inter text-4xl font-semibold text-neutral-dark-2 md:gap-[56px]">
      <Image
