...
//       try {
//         const response = await fetch(
//           "https://deployment.api-python.boilerplate.hng.tech/api/v1/waitlists/",
//           {
//             method: "POST",
//             headers: {
//               "Content-Type": "application/json",
...
//     <div className="mt-20 flex flex-col items-center justify-center text-neutral-dark-2">
//       <div className="text-center md:mb-[50px] md:w-[623px]">
//         <div className="mb-4 flex items-center justify-center gap-2 md:mb-2">
//           <Image
//             width={23}
//             height={21}
//             src="/images/WaitList/circle 1.svg"
//             alt="Circle with Tick"
//           />
//           <h3 className="text-[18px] font-medium leading-5">
//             Deployment made easy
//           </h3>
//         </div>
...
//           You can level up your SaaS production today
//         </h1>
//         <p className="text-center text-[16px] font-medium leading-5 md:text-[20px] md:leading-7">
//           Join our waitlist and get early access to our boilerplates
//         </p>
//       </div>

//       <div className="mt-20 flex h-auto w-[383.344px] shrink-0 items-start gap-[19.2px] rounded-md border border-gray-300 p-7 md:mt-5 md:w-[510px] md:p-2.5">
...
//               <CustomButton
//                 variant="primary"
//                 className="flex h-[51.78px] w-[195.6px] items-center justify-between rounded-md px-[19.2px] py-[9.6px] text-[16.8px] font-bold leading-[28.8px] text-white"
//                 type="submit"
//               >
//                 <Image
//                   width={20}
