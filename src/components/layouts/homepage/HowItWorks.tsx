    ...
    <div className="py-20 bg-[#ffffff]">
      <div className="mx-auto max-w-7xl px-5 md:px-10 lg:px-10 xl:px-10">
        <div className="flex flex-col lg:flex-row items-center">
          <div className="w-full lg:w-3/5 md:pr-10 lg:pr-20">
          ...
          <div className="w-full lg:w-2/5 flex flex-col items-end md:items-start">
            <div className="flex space-x-5 mb-9">
              <div>
                <Prebuilt />
              </div>
              <div>
                <h3 className="text-xl md-text-2xl font-bold font-inter mb-2" data-testid="prebuilt">Pre-Built Sections</h3>
            ...
            <div className="flex space-x-5 mb-9">
              ...
              <div>
                <h3 className="text-xl md-text-2xl font-bold font-inter mb-2" data-testid="scalable">Scalable Foundation</h3>
            ...
            <div className="flex space-x-5 mb-9">
              ...
              <div>
                <h3 className="text-xl md-text-2xl font-bold font-inter mb-2" data-testid="easy">Easy Customization</h3>
