  ...
  return (
    ...
    <div className="mx-auto max-w-7xl px-5 md:px-10 lg:px-10 xl:px-10 py-20">
      <div className="flex flex-col items-center justify-center">
        <div className="flex w-[300px] flex-col items-center sm:w-[400px] md:w-[500px] mb-4">
          <h3 className="text-[28px] font-[700] text-neutral-600 sm:text-[32px] md:text-[36px] lg:text-[40px] xl:text-[44px] mb-2">
            Our Core Values
          </h3>
        ...
        <div className="mt-[20px] grid w-full grid-cols-1 gap-[20px] sm:w-[500px] md:w-[750px] lg:w-[1000px] xl:w-[1200px] md:grid-cols-2">
