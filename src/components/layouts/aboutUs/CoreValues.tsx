    ...
    <div className="bg-white">
      <div className="mx-auto max-w-7xl px-5 py-20 md:px-10 lg:px-10 xl:px-10">
        <div className="flex flex-col items-center justify-center">
          <div className="mb-4 flex w-[382px] flex-col items-center sm:w-[400px] md:w-[500px]">
            <h3 className="mb-2 text-[28px] font-[600] max-sm:font-[700] max-sm:text-neutral-600 sm:text-[32px] md:text-[36px] lg:text-[44px]">
              Our Core Values
            </h3>
            <p className="text-center text-[16px] leading-[normal] text-neutral-600 md:text-[16px] lg:text-[18px]">
          ...
          <div className="mt-[20px] grid w-full grid-cols-1 gap-[20px] sm:w-[500px] md:w-[750px] md:grid-cols-2 lg:w-[1000px] xl:w-[1200px]">
            <div className="rounded-[10px] bg-[#f974161a] p-6 sm:p-8">
              <h3
                className="pb-4 text-center text-[28px] font-[700] text-primary sm:text-[20px]"
                data-testid="integrity"
              >
                Integrity
              </h3>
              <p className="text-[14px] font-[400] leading-[normal] text-neutral-600 md:text-[16px] lg:text-[18px]">
            ...
            <div className="rounded-[10px] bg-[#f974161a] p-6 sm:p-8">
              <h3 className="pb-4 text-center text-[28px] font-[700] text-primary sm:text-[20px]">
                Customer Centricity
              </h3>
              <p className="text-[14px] font-[400] leading-[normal] text-neutral-600 md:text-[16px] lg:text-[18px]">
            ...
            <div className="rounded-[10px] bg-[#f974161a] p-6 sm:p-8">
              <h3
                className="pb-4 text-[28px] font-[700] text-primary max-sm:text-center sm:text-[20px]"
                data-testid="innovation"
              >
                Innovation
              </h3>
              <p className="text-[14px] font-[400] leading-[19px] text-neutral-600 md:text-[16px] md:leading-[21.78px] lg:text-[18px]">
            ...
            <div className="rounded-[10px] bg-[#f974161a] p-6 sm:p-8">
              <h3 className="pb-4 text-[28px] font-[700] text-primary max-sm:text-center sm:text-[20px]">
                Excellence
              </h3>
              <p className="text-[14px] font-[400] leading-[19px] text-neutral-600 md:text-[16px] md:leading-[21.78px] lg:text-[18px]">
