...
const Footer = () => {
  return (
    <footer className="bg-gray-100 border-t border-gray-300 py-8 text-customGray">
      <div className="px-[3%]">
        <div className="container mx-auto hidden md:block">
          <div className="grid grid-cols-custom gap-">
            <div className="mb-6">
              <h5 className="font-bold mb-2 text-lg">BoilerPlate</h5>
              <p className="text-base whitespace-nowrap  xl:pr-20">
            ...
            {/* Newsletter section */}
            <div className="mb-6">
              <h5 className="font-bold mb-2 text-lg">Sign Up For Newsletter</h5>
              <div className="flex">
                <input
                  type="email"
