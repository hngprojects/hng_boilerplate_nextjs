...
import Eclipse from "../../../public/AboutUsImages/Ellipse.png";
  ...
  return (
    <div className="mx-auto mt-[80px] grid h-[307px] grid-cols-1 items-center max-sm:justify-between max-sm:gap-[32px] md:h-[225px] md:w-[1200px] md:grid-cols-2">
      <div className="flex h-[180px] flex-col justify-between gap-[24px] max-sm:items-center md:h-full">
        ...
        <p className="relative h-[115px] text-center text-[32px] font-[700] leading-[38px] text-neutral-600 max-sm:w-[380px] md:text-start md:text-[44px] md:font-[600] md:leading-[53px]">
      ...
      <div className="mx-auto h-[95px] w-[382px] md:h-[110px] md:w-[500px]">
        <p className="text-[18px] leading-[19px] text-neutral-600 max-sm:text-center md:leading-[22px]">
