...
import AboutOne from "../../../public/AboutUsImages/aboutUs_img_one.jpeg";
import Mask from "../../../public/AboutUsImages/Mask group-2.png";
import Mask2 from "../../../public/AboutUsImages/Mask group-3.png";
  ...
  return (
    <div className="relative top-[108px] flex h-[754px] flex-col justify-between md:h-[834px] md:w-full md:pb-[64px] md:pt-[64px]">
      <div className="mx-auto flex flex-col items-center justify-evenly max-sm:h-[302px] max-sm:w-[382px] max-sm:gap-[24px]">
        <p className="text-center text-[20px] font-[500] text-neutral-600 md:text-[28px]">
          About Us
        </p>
        <p className="text-center text-[32px] font-[700] text-neutral-600 max-sm:leading-[38px] md:text-[64px]">
          More Than Just A BoilerPlate
        </p>
        <p className="mx-auto h-[88px] w-[382px] text-center text-[18px] font-[400] leading-[22px] text-neutral-600 md:h-[66px] md:w-[584px]">
