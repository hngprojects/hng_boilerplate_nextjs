...
import VisionImg from "../../../public/AboutUsImages/vision_img.jpeg";
      ...
      <div className="flex items-center md:justify-start">
        <div className="flex h-[382px] w-[430px] flex-col gap-[24px] md:h-[264px] md:w-[500px]">
          <div className="mx-auto flex h-[119px] w-[211px] flex-col justify-evenly gap-[12px] max-sm:items-center md:h-[152px] md:w-[486px]">
            ...
            <p className="h-[106px] w-[382px] text-[32px] font-[700] text-neutral-600 max-md:text-center md:w-full md:text-[44px] md:font-[600] md:leading-[53px]">
              Leading the Way, Redefining Industries
            </p>
          </div>
          <p className="h-[88px] text-[18px] font-[400] leading-[22px] text-neutral-600 max-sm:w-[382px] max-sm:text-center">
