  ...
  return (
    <div className="mt-[150px] flex flex-col items-center justify-center md:mt-[80px]">
      <div className="flex w-[382px] flex-col items-center md:w-[500px]">
        <h3 className="text-[32px] font-[700] text-neutral-600 md:text-[44px] md:font-[600]">
          Our Core Values
        </h3>
        <p className="text-center text-[16px] leading-[22px] text-neutral-600 md:text-[18px]">
      ...
      <div className="mt-[40px] grid h-[876px] w-[382px] grid-cols-1 gap-[24px] max-sm:px-[10px] md:h-[424px] md:w-[1200px] md:grid-cols-2">
        <div className="flex h-[200px] flex-col items-center gap-[24px] rounded-[10px] bg-[#f974161a] px-[16px] md:w-[588px]">
          ...
          <p className="text-[16px] font-[400] leading-[19px] text-neutral-600 max-sm:text-center md:text-[18px] md:leading-[22px]">
        ...
        <div className="flex h-[200px] flex-col items-center gap-[24px] rounded-[10px] bg-[#f974161a] px-[16px] md:w-[588px]">
          ...
          <p className="text-[16px] font-[400] leading-[19px] text-neutral-600 max-sm:w-[350px] max-sm:text-center md:text-[18px] md:leading-[22px]">
