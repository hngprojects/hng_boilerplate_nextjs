...
function FreePlan() {
    return (
        ...
        <div className="flex flex-col md:gap-[24px] mt-[20px]">
            <p className="text-[24px] font-bold">Current Plan</p>
            <div className="flex flex-col gap-[8px] bg-[#FFF8F2] md:py-[24px] md:pr-[94px] md:pl-[17px] rounded-[12px]">
                <p className="text-[20px] font-semibold">Free</p>
                <p className="text-[13px]">Your account is on a free 90-day trial of our free plan, through September 27th, Upgrade anytime to stay on this plan when your trial ends.</p>
