    ...
    <div className="mx-auto w-full max-w-[1047px] px-5 py-3">
      ...
      <div className="font-Inter mt-[24px] w-full">
        ...
        <div className="mt-[24px] hidden md:block">
          ...
          {/* Highlight */}
          <div className="flex flex-col rounded-[12px] bg-[#FFF8F2] px-2">
            <div className="hidden py-[15px] lg:block">
              <h2 className="font-Inter text-[16px] font-semibold leading-[19.36px]">
                Highlights
              </h2>
            </div>
            <article className="hidden w-full grid-cols-1 justify-start gap-2 !pb-16 text-neutral-dark-2 md:grid-cols-2 min-[820px]:mt-[24px] lg:grid lg:grid-cols-3 xl:grid-cols-4">
