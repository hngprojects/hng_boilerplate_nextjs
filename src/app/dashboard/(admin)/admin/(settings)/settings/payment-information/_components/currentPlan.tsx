    ...
    <div className="mx-auto w-full max-w-[1047px] px-5 py-3">
      ...
      <div className="font-Inter w-full">
        ...
        <div className="hidden md:block">
          <article className="grid w-full grid-cols-1 justify-start gap-2 px-2 text-neutral-dark-2 sm:grid-cols-2 md:grid-cols-5">
            <div className="w-[152px] py-[15px]">
              <h4 className="font-Inter hidden text-[16px] font-semibold leading-[19.36px] md:block">
                Subscribe to your desired plan
              </h4>
            </div>
            {desiredPlan.map((items) => {
          ...
          {/* Highlight */}
          <article className="grid w-full grid-cols-1 justify-start gap-2 rounded-[12px] bg-[#FFF8F2] px-2 !pb-16 text-neutral-dark-2 sm:grid-cols-2 md:grid-cols-5">
        ...
        <div className="font-Inter flex w-full flex-col items-center md:hidden">
          {highLightMobile.map((items) => {
