  ...
  return (
    <div className="mx-[2rem] mb-[4rem] flex flex-col sm:mx-[4rem]">
      ...
      <section className="mt-4">
        ...
        <>
          {projectData.map((item: Dataprops) => (
            <div
              key={item.id}
              className="flex items-start justify-start border-[0.05rem] border-[#CBD5E1] px-2 py-4 text-[14px] sm:justify-start"
            >
      ...
      <section className="mt-4">
        ...
        <>
          {sharingData.map((item: Dataprops) => (
            <div
              key={item.id}
              className="flex items-center justify-start border-[0.05rem] border-[#CBD5E1] px-2 py-4 text-[14px] sm:justify-start"
            >
              <p className="basis-[70%] sm:basis-[45%]">{item.title}</p>
      ...
      <section className="mt-4">
        ...
        <>
          {supportData.map((item: Dataprops) => (
            <div
              key={item.id}
              className="justart flex items-center border-[0.05rem] border-[#CBD5E1] px-2 py-4 text-[14px] sm:justify-start"
            >
              <p className="basis-[70%] sm:basis-[45%]">{item.title}</p>
              <div className="basis-[25%] sm:basis-[45%]">
                <Image
      ...
      <section className="mt-4 flex-col">
        ...
        <div className="flex items-center justify-between border-[0.05rem] border-[#CBD5E1] px-2 py-4 text-[14px]">
      ...
      <div className="mt-6 flex items-center justify-center">
        ...
        <button className="text-neutralColor-dark-2 ml-2 rounded border-[0.05rem] border-[#CBD5E1] px-2 py-2 text-[10px] sm:ml-4 sm:px-4 sm:text-[12px]">
          Cancel Subscription
        </button>
      </div>
    </div>
