...
const JobDetails = () => {
  ...
  return (
    <Layout>
      <main className="mx-6 mt-8 flex flex-col xl:mx-[120px] 2xl:mx-[190px]">
        ...
        <div className="mb-4 mt-8 grid w-full auto-rows-min grid-cols-1 pb-2 md:grid-cols-3">
          <div className="col-span-1 mb-6 sm:col-span-2 md:mr-16 xl:mr-40">
            <div className="flex flex-col justify-start">
              <h1 className="mb-3 text-3xl font-bold text-neutral-dark-2 md:text-[44px]">
                Product Designer
              </h1>
              <div className="flex flex-col gap-8">
                <div className="flex flex-col gap-2">
                  <h3 className="mt-4 text-[20px] font-bold text-neutral-dark-1 md:text-[28px] md:text-neutral-dark-2">
                    Job Description
                  </h3>
                  <p className="text-[18px] font-normal text-neutral-dark-1 md:text-neutral-dark-2">
                ...
                <div className="flex flex-col gap-2">
                  <h3 className="text-[20px] font-bold text-neutral-dark-1 md:text-[28px] md:text-neutral-dark-2">
          ...
          <div className="col-span-1 flex flex-col gap-5 self-start xl:ml-[6rem]">
            <div className="flex max-w-[282px] flex-col items-start justify-start rounded-sm border border-stroke-colors-stroke px-6 py-6 sm:max-w-full">
              <h5 className="mb-1 text-[20px] font-semibold text-neutral-dark-1 md:md:text-neutral-dark-2">
                About the job
              </h5>
              <div className="mb-1 flex flex-col">
                ...
                <p className="text-lg md:text-neutral-dark-2">
                  July 19th, 2024
                </p>
              </div>
              <div className="mb-1 flex flex-col">
            ...
            <div className="flex max-w-[282px] flex-col items-start justify-start rounded-[6px] border border-stroke-colors-stroke px-6 py-6 sm:max-w-full">
              <h5 className="mb-1 text-[20px] font-semibold text-neutral-dark-1 md:text-neutral-dark-2">
                What we offer
              </h5>
            ...
            <div className="flex max-w-[282px] flex-col items-start justify-start rounded-[6px] border border-stroke-colors-stroke px-6 py-6 sm:max-w-full">
              ...
              <p className="text-[18px] font-normal text-neutral-dark-1 md:text-neutral-dark-2">
                ...
                <span className="text-[18px] font-medium text-neutral-dark-1 md:text-neutral-dark-2">
                  hng123@gmail.com
                </span>
              </p>
            </div>
        ...
        <div className="mb-8 flex flex-row items-center justify-center">
          <CustomButton
            ...
            isDisabled={false}
            className={`w-full px-28 py-2 sm:w-auto ${isSmallScreen ? "" : "flex items-center"}`}
          >
            Apply Now
          </CustomButton>
        </div>
