  ...
  return (
    <div>
      <main className="mt-8 flex min-h-screen flex-col px-[7.5rem] max-lg:px-10 max-md:px-5">
        <p className="text-neutral-dark-1 text-opacity-50 max-md:hidden">
          Contact Us / <span className="font-normal text-primary">FAQ</span>
        </p>
        <div className="flex flex-col gap-16">
          <p className="hidden text-neutral-dark-1 text-opacity-50 max-md:block">
            Contact Us &gt;{" "}
            <span className="font-normal text-primary">FAQ</span>
          </p>
          <div className="mb-20 mt-16 flex flex-col items-center justify-center gap-3 max-2xl:mb-4 max-lg:mb-12 max-md:mb-8 max-md:mt-6">
          ...
          <section className="flex w-full flex-col justify-start md:justify-center">
            <Faqs />
