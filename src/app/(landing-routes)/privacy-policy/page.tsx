...
export default function PrivacyPolicy() {
  ...
  return (
    <main className="mx-auto max-w-7xl bg-white px-5 py-5 sm:bg-transparent md:px-10 lg:px-10 xl:px-10">
      <Heading tag="Privacy Policy" title="How We {{Protect}} Your Information" content="Find advice and answers from our support team"/>

        <section className="flex max-w-full flex-col-reverse items-start justify-between pb-10 mt-20 lg:flex-row">
