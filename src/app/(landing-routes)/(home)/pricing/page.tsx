    ...
    <>
      <div className="mx-auto max-w-7xl px-5 py-20 md:px-10 lg:px-10 xl:px-10">
        <div className="mb-10 text-center md:mx-auto md:mb-12">
          <p className="mb-6 inline-block rounded-md bg-gray-200 px-4 py-1 text-sm text-black md:text-lg">
            Pricing
          </p>
          <h2 className="font-inter mb-6 text-center text-3xl font-bold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-[3.2rem]">
            Simple and <span className="text-orange-500">Affordable</span>{" "}
            Pricing Plan
          </h2>
          <p className="text-1xl md-text-xl mb-10 text-base text-gray-700">
            Our flexible plans are designed to scale with your business. We have
            a plan for you.
          </p>
        </div>

        <div className="align-center mx-auto mt-[100px] flex w-[380px] justify-between rounded-md bg-subtle p-2">
          <div
            onClick={() => setToggle(1)}
